...
**MANDATORY:** Read `/knowledge base/Product Owner - v0.926.md` **COMPLETELY** before proceeding.
...
Based on routing logic in v0.926, read supporting documents:
...
### DO NOT:
- ❌ Skip the system prompt (`/knowledge base/Product Owner - v0.926.md`)
- ❌ Proceed without reading v0.926 completely
...
### ALWAYS:
- ✅ Start with `/knowledge base/Product Owner - v0.926.md`
- ✅ Follow routing logic in v0.926 (Section 3)
- ✅ Apply file organization rules (v0.926 Section 3: File Organization)
- ✅ Respect processing hierarchy (v0.926 Section 3: Processing Hierarchy)
...
2. **System Prompt (v0.926)** - Read completely, contains all routing logic
3. **Apply Routing** - Follow shortcut detection in v0.926 Section 3
4. **Supporting Documents** - Read as determined by routing logic
5. **Create Deliverable** - Following all rules in v0.926

**→ GO TO:** `/knowledge base/Product Owner - v0.926.md` **NOW**